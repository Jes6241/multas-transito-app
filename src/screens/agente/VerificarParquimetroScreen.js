...
export default function VerificarParquimetroScreen({ navigation }) {
  ...
  const verificarParquimetro = async () => {
    ...
    try {
      // Usar la nueva API de Parquímetros
      const response = await fetch(API.PARQUIMETROS.VERIFICAR(placa.toUpperCase()));
              ...
              <View style={styles.infoCard}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoValue}>
                    ${resultado.monto_pagado} por {resultado.minutos_pagados} min
                  </Text>
                </View>
                <View style={styles. infoRow}>
