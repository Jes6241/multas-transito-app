...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = async () => {
    ...
    if (! result.success) {
      ...
      // Otros roles (agente, admin, corralon) se redirigen automáticamente por AppNavigator
    }
  };
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles. form}>
          ...
          {/* Botón para volver sin login */}
          <TouchableOpacity
            style={styles. backBtn}
            onPress={() => navigation.goBack()}
          >
            <Ionicons name="arrow-back" size={18} color={COLORS.gray[500]} />
            <Text style={styles.backBtnText}>Continuar sin iniciar sesión</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
